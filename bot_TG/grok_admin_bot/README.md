# 🤖 ChatGPT Telegram Bot - Администратор каналов

Мощный Telegram бот с интеграцией OpenAI ChatGPT для автоматического управления каналами, генерации статей и ответов на комментарии пользователей.
...
- `/test_chatgpt` - проверить подключение к OpenAI ChatGPT
...
├── chatgpt_api.py       # Клиент для работы с OpenAI ChatGPT API
